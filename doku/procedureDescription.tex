...
\begin{figure}[h!]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{nassis/City/updateVehicles-0.pdf}}
\end{figure}

\begin{figure}[h!]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{nassis/City/createNewVehicle-3.pdf}}
\end{figure}
