...
\begin{figure}[h!]
    \vspace{-2cm} 
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{nassis/Output/write-4.pdf}}
\end{figure}
...
\begin{figure}[h!]
        \vspace{-2cm} 
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{nassis/Output/writeStats.pdf}}
\end{figure}
...
\begin{figure}[h!]
            \vspace{-2cm} 
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{nassis/Output/writeVehicles.pdf}}
\end{figure}
\FloatBarrier
\vspace{-2cm}
\begin{figure}[h!]
